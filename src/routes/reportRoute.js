...
import { getReports, getReportByID, getReportsByUser, createReport, deleteReportByID, getReportCountByPost } from "../controllers/reportController.js";
...
reportRouter.get("/report/count/:id", verifyToken, verifyAdmin, getReportCountByPost);
